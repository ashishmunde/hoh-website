const IMAGE_BASE_URL = 'https://house-of-hair.s3.ap-south-1.amazonaws.com'
...
export const HOMEPAGE_IMAGES = [
  `${IMAGE_BASE_URL}/homepage/Balayage.jpg`,
  `${IMAGE_BASE_URL}/homepage/Global 1.jpg`,
  `${IMAGE_BASE_URL}/homepage/Highlighjts 1.jpg`,
  `${IMAGE_BASE_URL}/homepage/Highlighjts.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_105048_374.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_105117_855.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_110227_364.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_112650_002.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_113045_697.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_113455_565.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_113512_330.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_114100_209.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115104_980.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115307_981.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115335_659.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115352_925.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115520_441.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115605_344.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115758_185.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_115923_351.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124444_519.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124523_531.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124642_569.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124659_796.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124712_731.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124719_425.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124749_842.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124805_338.jpg`,
  `${IMAGE_BASE_URL}/homepage/IMG_20250801_124931_022.jpg`,
  `${IMAGE_BASE_URL}/homepage/balayage 1.jpg`,
  `${IMAGE_BASE_URL}/homepage/balayage 2.jpg`,
  `${IMAGE_BASE_URL}/homepage/balayage 3.jpg`,
]
...
export const MENS_HAIRCUT_IMAGES = [
  ...
  `${IMAGE_BASE_URL}/mens-haircut/IMG_20250801_114748_901.jpg`,
  `${IMAGE_BASE_URL}/mens-haircut/IMG_20250801_115010_685.jpg`,
  `${IMAGE_BASE_URL}/mens-haircut/IMG_20250801_115339_000.jpg`,

  `${IMAGE_BASE_URL}/mens-haircut/photo_2025-08-01_12-58-17.jpg`,
  `${IMAGE_BASE_URL}/mens-haircut/photo_2025-08-01_13-01-01.jpg`,
]

// Make-up and Hairstyle Images
export const MAKEUP_AND_HAIRSTYLE_IMAGES = [
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0507(1).JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0507.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0508(1).JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0508.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0510(1).JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0510.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0512(1).JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0512.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0518(1).JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0518.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0519(1).JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0519.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0521.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0528.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0530(1).JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/VK5_0530.JPG`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-29.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-31.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-34.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-35.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-37.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-42.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-43.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-44.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-46.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-48.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-49.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-58.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-54-59.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-55-00.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-55-01.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-55-02.jpg`,
  `${IMAGE_BASE_URL}/make-up-and-hairstyle/photo_2025-08-01_12-55-03.jpg`,
]
